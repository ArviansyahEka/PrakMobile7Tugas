...
import com.example.prakmobile7tugas.databinding.ActivityCheckoutBinding
...
class Checkout : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            val adapterBioskop =
                ArrayAdapter(this@Checkout, android.R.layout.simple_spinner_item, bioskop)
            spinnerbioskop.adapter = adapterBioskop

            val adapterJenisseat =
                ArrayAdapter(this@Checkout, android.R.layout.simple_spinner_item, jenisseat)
            spinnerseat.adapter = adapterJenisseat

            val adapterJenispembayaran = ArrayAdapter(
                this@Checkout, android.R.layout.simple_spinner_item, jenispembayaran
            )
            spinnerpembayaran.adapter = adapterJenispembayaran

            val adapterBank =
                ArrayAdapter(this@Checkout, android.R.layout.simple_spinner_item, bank)
            ...
            backbutton.setOnClickListener {
                val intent = Intent(this@Checkout, FilmSection::class.java)
                startActivity(intent)
            }

            bayar.setOnClickListener {
                val intent = Intent(this@Checkout, TicketFragment::class.java)
...
//
//                val action = CheckoutDirections.actionCheckoutToTicketFragment(judulFilm,genreFilm, selectedBioskop, selectedJenisseat, selectedJenispembayaran, selectedBank, date, selectedHarga, sumfee, gambar)
//
